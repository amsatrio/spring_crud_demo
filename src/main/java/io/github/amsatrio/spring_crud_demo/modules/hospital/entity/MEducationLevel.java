...
public class MEducationLevel implements Serializable {
    ...
    @Length(max = 10, message = "name must be between 0-10 characters")
    @JsonProperty("name")
	...
	public final boolean equals(Object o) {
		...
		MEducationLevel mEducationLevel = (MEducationLevel) o;
		return getId() != null && Objects.equals(getId(), mEducationLevel.getId());
	}
