...
public class TCustomerVa implements Serializable {
    ...
    @Length(max = 30, message = "va_number must be between 0-30 characters")
    @JsonProperty("vaNumber")
    @Column(name = "va_number", columnDefinition = "varchar(30)")
	...
	public final boolean equals(Object o) {
		...
		TCustomerVa tCustomerVa = (TCustomerVa) o;
		return getId() != null && Objects.equals(getId(), tCustomerVa.getId());
	}
