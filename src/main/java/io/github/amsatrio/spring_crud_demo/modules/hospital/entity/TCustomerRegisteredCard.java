...
public class TCustomerRegisteredCard implements Serializable {
    ...
    @Length(max = 20, message = "card_number must be between 0-20 characters")
    ...
    @Length(max = 5, message = "cvv must be between 0-5 characters")
    @JsonProperty("cvv")
    @Column(name = "cvv", columnDefinition = "varchar(5)")
    private String cvv;
	...
	public final boolean equals(Object o) {
		...
		TCustomerRegisteredCard tCustomerRegisteredCard = (TCustomerRegisteredCard) o;
		return getId() != null && Objects.equals(getId(), tCustomerRegisteredCard.getId());
	}
