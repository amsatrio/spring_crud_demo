...
public class TTreatmentDiscount implements Serializable {
    ...
    @JsonProperty("doctorOfficeTreatmentPriceId")
    @Column(name = "doctor_office_treatment_price_id", columnDefinition = "bigint")
    ...
    private TDoctorOfficeTreatmentPrice tDoctorOfficeTreatmentPrice;
	...
	public final boolean equals(Object o) {
		...
		TTreatmentDiscount tTreatmentDiscount = (TTreatmentDiscount) o;
		return getId() != null && Objects.equals(getId(), tTreatmentDiscount.getId());
	}
