...
public class MLocationLevel implements Serializable {
    ...
    @Length(max = 50, message = "abbreviation must be between 0-50 characters")
    @JsonProperty("abbreviation")
    @Column(name = "abbreviation", columnDefinition = "varchar(50)")
	...
	public final boolean equals(Object o) {
		...
		MLocationLevel mLocationLevel = (MLocationLevel) o;
		return getId() != null && Objects.equals(getId(), mLocationLevel.getId());
	}
