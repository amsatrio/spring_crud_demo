...
public class MDoctor implements Serializable {
    ...
    @Length(max = 50, message = "str must be between 0-50 characters")
    @JsonProperty("strCode")
    @Column(name = "str_code", columnDefinition = "varchar(50)")
    private String str;
	...
	public final boolean equals(Object o) {
		...
		MDoctor mDoctor = (MDoctor) o;
		return getId() != null && Objects.equals(getId(), mDoctor.getId());
	}
