...
public class TDoctorOffice implements Serializable {
    ...
    @Length(max = 100, message = "specialization must be between 0-100 characters")
	...
	public final boolean equals(Object o) {
		...
		TDoctorOffice tDoctorOffice = (TDoctorOffice) o;
		return getId() != null && Objects.equals(getId(), tDoctorOffice.getId());
	}
