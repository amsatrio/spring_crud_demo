...
public class TMedicalItemPurchaseDetail implements Serializable {
    ...
    @Column(name = "courier_id", columnDefinition = "bigint")
    ...
    private TMedicalItemPurchase tMedicalItemPurchase;

    @ManyToOne
    @JoinColumn(name="medical_item_id", insertable = false, updatable = false)
    private MMedicalItem mMedicalItem;
	...
	public final boolean equals(Object o) {
		...
		TMedicalItemPurchaseDetail tMedicalItemPurchaseDetail = (TMedicalItemPurchaseDetail) o;
		return getId() != null && Objects.equals(getId(), tMedicalItemPurchaseDetail.getId());
	}
