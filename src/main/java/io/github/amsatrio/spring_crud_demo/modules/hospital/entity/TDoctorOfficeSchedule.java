...
public class TDoctorOfficeSchedule implements Serializable {
    ...
    @JsonProperty("medicalFacilityScheduleId")
    @Column(name = "medical_facility_schedule_id", columnDefinition = "bigint")
    private Long medicalFacilityScheduleId;

    @JsonProperty("slot")
    @Column(name = "slot", columnDefinition = "int")
	...
	public final boolean equals(Object o) {
		...
		TDoctorOfficeSchedule tDoctorOfficeSchedule = (TDoctorOfficeSchedule) o;
		return getId() != null && Objects.equals(getId(), tDoctorOfficeSchedule.getId());
	}
