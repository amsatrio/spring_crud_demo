...
public class MBank implements Serializable {
    ...
    @Length(max = 100, message = "name must be between 0-100 characters")
    @JsonProperty("name")
    @Column(name = "name", columnDefinition = "varchar(100)")
    private String name;

    @Length(max = 10, message = "va_code must be between 0-10 characters")
    @JsonProperty("vaCode")
    @Column(name = "va_code", columnDefinition = "varchar(10)")
	...
	public final boolean equals(Object o) {
		...
		MBank mBank = (MBank) o;
		return getId() != null && Objects.equals(getId(), mBank.getId());
	}
