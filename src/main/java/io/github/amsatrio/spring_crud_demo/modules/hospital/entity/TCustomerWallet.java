...
public class TCustomerWallet implements Serializable {
    ...
    @Length(max = 6, message = "pin must be between 0-6 characters")
    @JsonProperty("pin")
    @Column(name = "pin", columnDefinition = "varchar(6)")
    private String pin;
    ...
    @Length(max = 50, message = "barcode must be between 0-50 characters")
    @JsonProperty("barcode")
    @Column(name = "barcode", columnDefinition = "varchar(50)")
    private String barcode;

    @JsonProperty("points")
    @Column(name = "points", columnDefinition = "decimal")
	...
	public final boolean equals(Object o) {
		...
		TCustomerWallet tCustomerWallet = (TCustomerWallet) o;
		return getId() != null && Objects.equals(getId(), tCustomerWallet.getId());
	}
