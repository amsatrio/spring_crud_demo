...
public class TDoctorOfficeTreatment implements Serializable {
    ...
    @JsonProperty("doctorTreatmentId")
    @Column(name = "doctor_treatment_id", columnDefinition = "bigint")
    ...
    private TDoctorTreatment tDoctorTreatment;
	...
	public final boolean equals(Object o) {
		...
		TDoctorOfficeTreatment tDoctorOfficeTreatment = (TDoctorOfficeTreatment) o;
		return getId() != null && Objects.equals(getId(), tDoctorOfficeTreatment.getId());
	}
