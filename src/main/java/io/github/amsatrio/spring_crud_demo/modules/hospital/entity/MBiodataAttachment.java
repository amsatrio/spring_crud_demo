...
public class MBiodataAttachment implements Serializable {
    ...
    @Length(max = 50, message = "file_name must be between 0-50 characters")
    @JsonProperty("fileName")
    @Column(name = "file_name", columnDefinition = "varchar(50)")
    private String fileName;

    @Length(max = 100, message = "file_path must be between 0-100 characters")
	...
	public final boolean equals(Object o) {
		...
		MBiodataAttachment mBiodataAttachment = (MBiodataAttachment) o;
		return getId() != null && Objects.equals(getId(), mBiodataAttachment.getId());
	}
