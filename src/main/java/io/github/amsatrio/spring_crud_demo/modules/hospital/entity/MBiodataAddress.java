...
public class MBiodataAddress implements Serializable {
    ...
    @Length(max = 15, message = "recipient_phone_number must be between 0-15 characters")
    ...
    @Length(max = 10, message = "postal_code must be between 0-10 characters")
	...
	public final boolean equals(Object o) {
		...
		MBiodataAddress mBiodataAddress = (MBiodataAddress) o;
		return getId() != null && Objects.equals(getId(), mBiodataAddress.getId());
	}
