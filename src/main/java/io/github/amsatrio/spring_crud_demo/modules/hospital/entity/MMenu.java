...
public class MMenu implements Serializable {
    ...
    @Length(max = 20, message = "name must be between 0-20 characters")
    @JsonProperty("name")
    @Column(name = "name", columnDefinition = "varchar(20)")
    private String name;

    @Length(max = 50, message = "url must be between 0-50 characters")
    @JsonProperty("url")
    ...
    @Length(max = 100, message = "big_icon must be between 0-100 characters")
    @JsonProperty("bigIcon")
    @Column(name = "big_icon", columnDefinition = "varchar(100)")
    private String bigIcon;

    @Length(max = 100, message = "small_icon must be between 0-100 characters")
    @JsonProperty("smallIcon")
    @Column(name = "small_icon", columnDefinition = "varchar(100)")
	...
	public final boolean equals(Object o) {
		...
		MMenu mMenu = (MMenu) o;
		return getId() != null && Objects.equals(getId(), mMenu.getId());
	}
