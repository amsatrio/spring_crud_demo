package io.github.amsatrio.spring_crud_demo.modules.hospital.m_role;
...
public class MRole implements Serializable {
    ...
    @Length(max = 20, message = "code must be between 0-20 characters")
    @JsonProperty("code")
	...
	public final boolean equals(Object o) {
		...
		MRole mRole = (MRole) o;
		return getId() != null && Objects.equals(getId(), mRole.getId());
	}
